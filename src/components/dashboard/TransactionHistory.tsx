    ...
    <div className="px-[16px]">
      <div className="w-full">
        <div className="text-[14px] w-full font-[500] flex items-center justify-between">
          ...
          <Link href="/dashboard/transactions" className="text-[13px] font-[500] text-[#cc0000]">
            See All
          </Link>
        </div>
            ...
            <div key={transaction.transaction_id} className="flex justify-between gap-1 py-3">
              <div className="flex gap-2 text-gray-800">
                ...
                <div className="flex flex-col gap-1 justify-between">
                  <span className="text-[14px] font-[600] w-[200px] uppercase sm:max-w-full">{transaction.description}</span>
